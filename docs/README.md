...
- **[Web Bluetooth Configurator (PWA)](file:///workspaces/snippen-sms-service/docs/BLE_WEB_CONFIG.md)**: Web-based BLE provisioning and diagnostics app hosted on GitHub Pages.
- **[Manual BLE Provisioning Guide (nRF Connect)](file:///workspaces/snippen-sms-service/docs/BLE_MANUAL_TESTING.md)**: Manual testing guide for BLE GATT provisioning using nRF Connect for Mobile.
...
- **[Lilygo T-Call A7670E Standalone Hardware Guide](file:///workspaces/snippen-sms-service/docs/README_LILYGO.md)**: Standalone ESP32 hardware setup, pinout, MicroPython environment, SIM configuration, and AT commands.
